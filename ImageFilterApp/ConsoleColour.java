...
/**
 * Ascii codes to format console output. Stored as constants in an Enum.
 * 
 * @author John Healy
 *
 */
...
public enum ConsoleColour { //ANSI escape codes. These make the UI look a little more presentable.
    ...
    WHITE_BG_BLACK_TXT("\033[38;5;0;48;5;15m"), //White background with black text
    ...
    YELLOW_BRIGHT("\033[0;911m"), 				//YELLOW
